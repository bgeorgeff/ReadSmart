      ...
      <header className="relative z-10 bg-white/80 backdrop-blur-md border-b border-white/20 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div 
              className="flex items-center justify-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 hover:-translate-y-1 cursor-pointer"
      ...
      <main className="relative z-10 container mx-auto px-4 py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Turn complex texts from any website or PDF into readable chunks. Perfect for dyslexic adults or teens who want to practice their reading skills privately. Teachers and tutors can use it to generate text for older students - from motorcycle racing to classic literature.
          </p>
        ...
        <div className="mt-8 mb-12 max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            {/* Use Case 2 - Right (Reading Practice) */}
            <div className="bg-white/80 backdrop-blur-sm border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 rounded-2xl overflow-hidden">
              <img 
                src={use1Image} 
