...
- July 7, 2025. Fixed syllable division accuracy by replacing Hypher.js with custom dictionary plus syllable package approach. Now provides correct divisions like "community" → "com • mu • ni • ty" instead of inaccurate "com • mu • nity". Dictionary contains 50+ common words with proper syllable breaks, fallback algorithm for unknown words.
